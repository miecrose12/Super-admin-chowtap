...
const ProductModal = ({ item, onClose }) => {
  ...
  const displayItem = {
    name: item?.line1 && item?.line2 ? `${item.line1} ${item.line2}` : 'Jollof Rice',
    price: item?.price || '₦200.00',
    category: item?.cat || 'Main Dish',
    vendor: item?.vendor || 'Abula Spot',
    image: item?.img || 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&q=80&w=800'
  };
      ...
      <div className="bg-[#111] w-full max-w-5xl rounded-2xl overflow-hidden flex flex-col md:flex-row border border-white/10 relative shadow-2xl">
        ...
        <div className="w-full md:w-[45%] relative h-[300px] md:h-auto">
          ...
          <div className="absolute bottom-0 left-0 p-8 flex flex-col gap-2">
            <span className="bg-[#e58230] text-black text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wider w-max">
              Signature Choice
            </span>
            <h1 className="text-4xl font-bold text-white tracking-tight">{displayItem.name}</h1>
          </div>
        </div>
        ...
        <div className="w-full md:w-[55%] p-8 lg:p-10 flex flex-col bg-[#111]">
          ...
          <div className="flex justify-between items-start mb-8">
            <div>
              <h2 className="text-[#e58230] text-xs font-bold uppercase tracking-[0.15em] mb-1">{displayItem.name}</h2>
              <p className="text-neutral-400 text-sm">Vendor: {displayItem.vendor}</p>
            </div>
            <div className="text-right">
              <div className="text-2xl font-bold text-white">{displayItem.price}</div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            ...
            <div className="bg-[#1a1a1a] p-4 rounded-xl border border-white/5">
              <svg className="w-4 h-4 text-[#e58230] mb-2" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd"></path></svg>
            ...
            {/* Order Count */}
            <div className="bg-[#1a1a1a] p-4 rounded-xl border border-white/5">
              <svg className="w-4 h-4 text-[#e58230] mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
            ...
            {/* Category */}
            <div className="bg-[#1a1a1a] p-4 rounded-xl border border-white/5">
              <svg className="w-4 h-4 text-[#e58230] mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
              <div className="text-[10px] text-neutral-500 font-bold uppercase tracking-wider mb-1">Category</div>
              <div className="text-white font-bold text-lg">{displayItem.category}</div>
            </div>

            {/* Prep Time */}
            <div className="bg-[#1a1a1a] p-4 rounded-xl border border-white/5">
              <svg className="w-4 h-4 text-[#e58230] mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
